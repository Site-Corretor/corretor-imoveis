            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-primary" target="_blank"
                            href="editarCasa.php?codigo=<?php echo $casasCadastradas[$i]['codigo']; ?>">Editar</a></td>
                    <td><a class="btn btn-danger" target="_blank"
                            href="excluirCasa.php?codigo=<?php echo $casasCadastradas[$i]['codigo']; ?>">Excluir</a>
                    </td>
                </tr>
                <?php }
                        }
                ...
                <tr>
                    ...
                    <td><a class="btn btn-primary" target="_blank"
                            href="editarCasa.php?codigo=<?php echo $casaPesquisada['codigo']; ?>">Editar</a></td>
                    <td><a class="btn btn-danger" target="_blank"
                            href="excluirCasa.php?codigo=<?php echo $casaPesquisada['codigo']; ?>">Excluir</a></td>
                </tr>
