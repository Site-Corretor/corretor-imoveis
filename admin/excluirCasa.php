        ...
        <a href="casasCadastradas.php" class="btn btn-primary mt-3 mb-3">Voltar</a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="total-area" placeholder="Total de Área" value="<?php echo $VisualizarCasa[0]['total_area']; ?>" disabled>
                </div>

                <div class="col-md-4">
                    <label for="dormitorios" class="form-label">Dormitórios</label>
                    <input type="text" class="form-control" name="dormitorios" placeholder="Dormitórios" value="<?php echo $VisualizarCasa[0]['dormitorios']; ?>"disabled >
                </div>

                <div class="col-md-4">
                    <label for="banheiros" class="form-label">Banheiros</label>
                    <input type="text" class="form-control" name="banheiros" placeholder="Banheiros" value="<?php echo $VisualizarCasa[0]['banheiros']; ?>" disabled>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="vagas" placeholder="Vagas" value="<?php echo $VisualizarCasa[0]['vagas']; ?>" disabled>
                </div>
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" name="descricao" placeholder="Descrição" value="<?php echo $VisualizarCasa[0]['descricao']; ?>" disabled>
                </div>
                <div class="col-md-4">
            ...
            <button type="submit" class="btn btn-primary mt-3" name="excluir">Excluir Imovel</button>
